...
struct HeartProjection: GroupActivity {
    var metadata: GroupActivityMetadata {
        ...
        data.title = String(localized: "Doodle Vision", comment: "The name of the game.")
        data.subtitle = String(localized: "See how well drawing immersive space game.", comment: "Subtitle text for the SharePlay join dialog.")
        data.supportsContinuationOnTV = false
        return data
    }
    static var activityIdentifier = "com.visionhack.doodlevision"
}
